...
export default function Pra({isOpen}: Props) {
  ...
  return (
    ...
    <main className="flex flex-col justify-between items-center h-screen min-h-screen min-w-screen">
      ...
      <div className="flex justify-between flex-col items-center medium:space-y-0 h-full  medium:flex-row xMedium:h-[90vh]  medium:gap-12 w-[410px] medium:w-[95%] medium:min-w-[1000px] medium:min-h-[750px] medium:mx-auto">
